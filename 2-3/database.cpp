...
DataBase::DataBase(QString _name , QString _login , QString _pass)
{
    ...
    pass = _pass;
    is_auth = true;
    addMessage(Information , "База даних створена.");
}
...
void DataBase::addMessage(MessageType type , QString mess){
...
DataTable DataBase::Intersect(vector<QString> pt){
    vector<DataTable> v;
    set<QString> tmp;
